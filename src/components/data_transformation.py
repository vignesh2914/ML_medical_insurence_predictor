...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            numerical_columns = ["bmi", "children", "charges"]
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        # Check for 'charges' column
            if 'charges' not in train_df.columns:
                raise ValueError("'charges' column is not present in the training DataFrame")
            if 'charges' not in test_df.columns:
                raise ValueError("'charges' column is not present in the test DataFrame")

            # Convert columns to numeric, coercing errors to NaN and dropping NaNs
            ...
            train_df = train_df.dropna(subset=["age", "bmi", "children", "charges"])
            test_df = test_df.dropna(subset=["age", "bmi", "children", "charges"])
            ...
            numerical_columns = ["charges", "bmi", "children"]
